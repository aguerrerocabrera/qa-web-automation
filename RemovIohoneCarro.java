...
//Instruccion con dos parametros (tipo de driver y ruta a donde esta el driver)//
        ...
        WebElement buttonremove = driver.findElement(By.xpath("//*[@id='cart']/ul/li[1]/table/tbody/tr/td[5]/button"));
        buttonremove.click();
        Thread.sleep(5000);

        WebElement buttonmsg = driver.findElement(By.xpath("//*[@id='cart']"));
        buttonmsg.click();
        Thread.sleep(5000);
